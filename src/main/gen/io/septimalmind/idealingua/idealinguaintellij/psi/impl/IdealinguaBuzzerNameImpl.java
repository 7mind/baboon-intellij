...
public class IdealinguaBuzzerNameImpl extends ASTWrapperPsiElement implements IdealinguaBuzzerName {

  public IdealinguaBuzzerNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitBuzzerName(this);
  }
