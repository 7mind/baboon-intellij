...
public class IdealinguaIdImpl extends ASTWrapperPsiElement implements IdealinguaId {

  public IdealinguaIdImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaIdMember> getIdMemberList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaIdMember.class);
  }
