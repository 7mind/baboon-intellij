...
public class IdealinguaStreamsImpl extends ASTWrapperPsiElement implements IdealinguaStreams {

  public IdealinguaStreamsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitStreams(this);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaStreamValue> getStreamValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaStreamValue.class);
  }
