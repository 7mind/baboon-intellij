...
public class IdealinguaForeignImpl extends ASTWrapperPsiElement implements IdealinguaForeign {

  public IdealinguaForeignImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaForeignMember> getForeignMemberList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaForeignMember.class);
  }
