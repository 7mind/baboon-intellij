...
public class IdealinguaOutputVoidImpl extends ASTWrapperPsiElement implements IdealinguaOutputVoid {

  public IdealinguaOutputVoidImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitOutputVoid(this);
  }
