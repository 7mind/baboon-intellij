...
public class IdealinguaDownstreamImpl extends ASTWrapperPsiElement implements IdealinguaDownstream {

  public IdealinguaDownstreamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitDownstream(this);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaStreamParam> getStreamParamList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaStreamParam.class);
  }
