...
public class IdealinguaOutputAdtImpl extends ASTWrapperPsiElement implements IdealinguaOutputAdt {

  public IdealinguaOutputAdtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitOutputAdt(this);
  }
  ...
  public IdealinguaAdtEnclosed getAdtEnclosed() {
    return notNullChild(PsiTreeUtil.getChildOfType(this, IdealinguaAdtEnclosed.class));
  }
