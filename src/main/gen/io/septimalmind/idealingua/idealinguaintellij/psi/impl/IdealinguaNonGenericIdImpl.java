...
public class IdealinguaNonGenericIdImpl extends ASTWrapperPsiElement implements IdealinguaNonGenericId {

  public IdealinguaNonGenericIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitNonGenericId(this);
  }
