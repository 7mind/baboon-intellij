...
public class IdealinguaListDefImpl extends ASTWrapperPsiElement implements IdealinguaListDef {

  public IdealinguaListDefImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaConstValue> getConstValueList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaConstValue.class);
  }
