...
public class IdealinguaSeparatorStructImpl extends ASTWrapperPsiElement implements IdealinguaSeparatorStruct {

  public IdealinguaSeparatorStructImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitSeparatorStruct(this);
  }
