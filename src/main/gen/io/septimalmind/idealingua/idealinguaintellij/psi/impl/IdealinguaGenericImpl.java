...
public class IdealinguaGenericImpl extends ASTWrapperPsiElement implements IdealinguaGeneric {

  public IdealinguaGenericImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaGenericId> getGenericIdList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaGenericId.class);
  }
