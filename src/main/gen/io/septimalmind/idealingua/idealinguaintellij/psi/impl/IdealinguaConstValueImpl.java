...
public class IdealinguaConstValueImpl extends ASTWrapperPsiElement implements IdealinguaConstValue {

  public IdealinguaConstValueImpl(@NotNull ASTNode node) {
    super(node);
  }
