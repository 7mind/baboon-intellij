...
public class IdealinguaSeparatorEnumImpl extends ASTWrapperPsiElement implements IdealinguaSeparatorEnum {

  public IdealinguaSeparatorEnumImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitSeparatorEnum(this);
  }
