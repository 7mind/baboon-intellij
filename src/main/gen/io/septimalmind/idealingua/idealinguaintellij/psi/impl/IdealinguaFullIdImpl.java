...
public class IdealinguaFullIdImpl extends ASTWrapperPsiElement implements IdealinguaFullId {

  public IdealinguaFullIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitFullId(this);
  }
