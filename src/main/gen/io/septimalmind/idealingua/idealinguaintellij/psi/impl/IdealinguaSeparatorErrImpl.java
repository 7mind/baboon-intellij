...
public class IdealinguaSeparatorErrImpl extends ASTWrapperPsiElement implements IdealinguaSeparatorErr {

  public IdealinguaSeparatorErrImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitSeparatorErr(this);
  }
