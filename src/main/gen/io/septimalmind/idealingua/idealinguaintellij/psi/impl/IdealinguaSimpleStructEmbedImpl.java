...
public class IdealinguaSimpleStructEmbedImpl extends ASTWrapperPsiElement implements IdealinguaSimpleStructEmbed {

  public IdealinguaSimpleStructEmbedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitSimpleStructEmbed(this);
  }
