...
public class IdealinguaDomainNameImpl extends ASTWrapperPsiElement implements IdealinguaDomainName {

  public IdealinguaDomainNameImpl(@NotNull ASTNode node) {
    super(node);
  }
