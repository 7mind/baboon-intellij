...
public class IdealinguaBuzzerImpl extends ASTWrapperPsiElement implements IdealinguaBuzzer {

  public IdealinguaBuzzerImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaBuzzerMethod> getBuzzerMethodList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaBuzzerMethod.class);
  }
