...
public class IdealinguaEnumEnclosedImpl extends ASTWrapperPsiElement implements IdealinguaEnumEnclosed {

  public IdealinguaEnumEnclosedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitEnumEnclosed(this);
  }
