...
public class IdealinguaStructMinusValueImpl extends ASTWrapperPsiElement implements IdealinguaStructMinusValue {

  public IdealinguaStructMinusValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitStructMinusValue(this);
  }
