...
public class IdealinguaUpstreamImpl extends ASTWrapperPsiElement implements IdealinguaUpstream {

  public IdealinguaUpstreamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitUpstream(this);
  }
