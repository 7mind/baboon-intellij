...
public class IdealinguaStructPlusValueImpl extends ASTWrapperPsiElement implements IdealinguaStructPlusValue {

  public IdealinguaStructPlusValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitStructPlusValue(this);
  }
