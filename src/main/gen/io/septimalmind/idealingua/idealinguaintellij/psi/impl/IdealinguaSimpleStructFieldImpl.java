...
public class IdealinguaSimpleStructFieldImpl extends ASTWrapperPsiElement implements IdealinguaSimpleStructField {

  public IdealinguaSimpleStructFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitSimpleStructField(this);
  }
