...
public class IdealinguaGenericIdImpl extends ASTWrapperPsiElement implements IdealinguaGenericId {

  public IdealinguaGenericIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitGenericId(this);
  }
