...
public class IdealinguaObjDefImpl extends ASTWrapperPsiElement implements IdealinguaObjDef {

  public IdealinguaObjDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitObjDef(this);
  }
