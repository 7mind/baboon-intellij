...
public class IdealinguaBuzzerMethodParamImpl extends ASTWrapperPsiElement implements IdealinguaBuzzerMethodParam {

  public IdealinguaBuzzerMethodParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitBuzzerMethodParam(this);
  }
