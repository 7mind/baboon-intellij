...
public class IdealinguaServiceImpl extends ASTWrapperPsiElement implements IdealinguaService {

  public IdealinguaServiceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaServiceMethod> getServiceMethodList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaServiceMethod.class);
  }
