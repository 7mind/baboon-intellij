...
public class IdealinguaEnumValuesImpl extends ASTWrapperPsiElement implements IdealinguaEnumValues {

  public IdealinguaEnumValuesImpl(@NotNull ASTNode node) {
    super(node);
  }
