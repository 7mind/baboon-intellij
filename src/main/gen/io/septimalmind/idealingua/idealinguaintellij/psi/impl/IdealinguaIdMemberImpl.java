...
public class IdealinguaIdMemberImpl extends ASTWrapperPsiElement implements IdealinguaIdMember {

  public IdealinguaIdMemberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitIdMember(this);
  }
