...
public class IdealinguaAdtEnclosedImpl extends ASTWrapperPsiElement implements IdealinguaAdtEnclosed {

  public IdealinguaAdtEnclosedImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitAdtEnclosed(this);
  }
