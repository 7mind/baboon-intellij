...
public class IdealinguaPackageIdImpl extends ASTWrapperPsiElement implements IdealinguaPackageId {

  public IdealinguaPackageIdImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitPackageId(this);
  }
