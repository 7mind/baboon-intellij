...
public class IdealinguaSimpleStructAnyImpl extends ASTWrapperPsiElement implements IdealinguaSimpleStructAny {

  public IdealinguaSimpleStructAnyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitSimpleStructAny(this);
  }
