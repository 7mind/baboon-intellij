...
public class IdealinguaEnumMinusValueImpl extends ASTWrapperPsiElement implements IdealinguaEnumMinusValue {

  public IdealinguaEnumMinusValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitEnumMinusValue(this);
  }
