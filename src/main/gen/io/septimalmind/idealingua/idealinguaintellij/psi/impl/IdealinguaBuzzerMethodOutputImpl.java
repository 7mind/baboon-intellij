...
public class IdealinguaBuzzerMethodOutputImpl extends ASTWrapperPsiElement implements IdealinguaBuzzerMethodOutput {

  public IdealinguaBuzzerMethodOutputImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitBuzzerMethodOutput(this);
  }
