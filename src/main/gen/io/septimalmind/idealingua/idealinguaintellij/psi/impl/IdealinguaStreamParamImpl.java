...
public class IdealinguaStreamParamImpl extends ASTWrapperPsiElement implements IdealinguaStreamParam {

  public IdealinguaStreamParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitStreamParam(this);
  }
