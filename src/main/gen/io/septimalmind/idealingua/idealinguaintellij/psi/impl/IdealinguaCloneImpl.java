...
public class IdealinguaCloneImpl extends ASTWrapperPsiElement implements IdealinguaClone {

  public IdealinguaCloneImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaClassName> getClassNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaClassName.class);
  }

  @Override
  @Nullable
  public IdealinguaStructMembers getStructMembers() {
    return PsiTreeUtil.getChildOfType(this, IdealinguaStructMembers.class);
  }
