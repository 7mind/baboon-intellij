...
public class IdealinguaServiceMethodParamImpl extends ASTWrapperPsiElement implements IdealinguaServiceMethodParam {

  public IdealinguaServiceMethodParamImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitServiceMethodParam(this);
  }
