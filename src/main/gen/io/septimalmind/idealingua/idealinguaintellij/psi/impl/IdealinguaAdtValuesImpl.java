...
public class IdealinguaAdtValuesImpl extends ASTWrapperPsiElement implements IdealinguaAdtValues {

  public IdealinguaAdtValuesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitAdtValues(this);
  }
