...
public class IdealinguaStringLiteralImpl extends ASTWrapperPsiElement implements IdealinguaStringLiteral {

  public IdealinguaStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaStringEscape> getStringEscapeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaStringEscape.class);
  }
