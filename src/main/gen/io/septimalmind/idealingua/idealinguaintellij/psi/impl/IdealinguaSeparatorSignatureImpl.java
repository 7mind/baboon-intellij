...
public class IdealinguaSeparatorSignatureImpl extends ASTWrapperPsiElement implements IdealinguaSeparatorSignature {

  public IdealinguaSeparatorSignatureImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitSeparatorSignature(this);
  }
