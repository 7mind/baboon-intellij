...
public class IdealinguaStreamsNameImpl extends ASTWrapperPsiElement implements IdealinguaStreamsName {

  public IdealinguaStreamsNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitStreamsName(this);
  }
