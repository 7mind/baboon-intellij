...
public class IdealinguaStructNameImpl extends ASTWrapperPsiElement implements IdealinguaStructName {

  public IdealinguaStructNameImpl(@NotNull ASTNode node) {
    super(node);
  }
