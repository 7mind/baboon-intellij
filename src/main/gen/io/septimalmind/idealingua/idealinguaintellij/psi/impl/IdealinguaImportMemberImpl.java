...
public class IdealinguaImportMemberImpl extends ASTWrapperPsiElement implements IdealinguaImportMember {

  public IdealinguaImportMemberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitImportMember(this);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaClassType> getClassTypeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaClassType.class);
  }
