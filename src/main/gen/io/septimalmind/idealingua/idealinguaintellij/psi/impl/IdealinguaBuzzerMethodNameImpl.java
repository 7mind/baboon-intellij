...
public class IdealinguaBuzzerMethodNameImpl extends ASTWrapperPsiElement implements IdealinguaBuzzerMethodName {

  public IdealinguaBuzzerMethodNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitBuzzerMethodName(this);
  }
