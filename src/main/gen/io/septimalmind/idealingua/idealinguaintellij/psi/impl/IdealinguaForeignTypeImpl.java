...
public class IdealinguaForeignTypeImpl extends ASTWrapperPsiElement implements IdealinguaForeignType {

  public IdealinguaForeignTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitForeignType(this);
  }
