...
public class IdealinguaStructEmbedValueImpl extends ASTWrapperPsiElement implements IdealinguaStructEmbedValue {

  public IdealinguaStructEmbedValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitStructEmbedValue(this);
  }
