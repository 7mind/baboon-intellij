...
public class IdealinguaServiceNameImpl extends ASTWrapperPsiElement implements IdealinguaServiceName {

  public IdealinguaServiceNameImpl(@NotNull ASTNode node) {
    super(node);
  }
