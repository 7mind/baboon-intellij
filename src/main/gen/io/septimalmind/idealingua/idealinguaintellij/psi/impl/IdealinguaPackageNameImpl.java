...
public class IdealinguaPackageNameImpl extends ASTWrapperPsiElement implements IdealinguaPackageName {

  public IdealinguaPackageNameImpl(@NotNull ASTNode node) {
    super(node);
  }
