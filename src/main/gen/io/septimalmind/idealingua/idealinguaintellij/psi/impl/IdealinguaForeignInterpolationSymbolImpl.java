...
public class IdealinguaForeignInterpolationSymbolImpl extends ASTWrapperPsiElement implements IdealinguaForeignInterpolationSymbol {

  public IdealinguaForeignInterpolationSymbolImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitForeignInterpolationSymbol(this);
  }
