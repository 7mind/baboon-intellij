...
public class IdealinguaEnumEmbedValueImpl extends ASTWrapperPsiElement implements IdealinguaEnumEmbedValue {

  public IdealinguaEnumEmbedValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitEnumEmbedValue(this);
  }
