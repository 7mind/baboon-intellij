...
public class IdealinguaIdMemberNameImpl extends ASTWrapperPsiElement implements IdealinguaIdMemberName {

  public IdealinguaIdMemberNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitIdMemberName(this);
  }
