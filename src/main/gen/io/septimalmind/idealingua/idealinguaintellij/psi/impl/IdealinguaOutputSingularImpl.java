...
public class IdealinguaOutputSingularImpl extends ASTWrapperPsiElement implements IdealinguaOutputSingular {

  public IdealinguaOutputSingularImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitOutputSingular(this);
  }
