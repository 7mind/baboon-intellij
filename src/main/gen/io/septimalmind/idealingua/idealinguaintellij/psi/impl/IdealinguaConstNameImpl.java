...
public class IdealinguaConstNameImpl extends ASTWrapperPsiElement implements IdealinguaConstName {

  public IdealinguaConstNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull IdealinguaVisitor visitor) {
    visitor.visitConstName(this);
  }
