...
public class IdealinguaStringEscapeImpl extends ASTWrapperPsiElement implements IdealinguaStringEscape {

  public IdealinguaStringEscapeImpl(@NotNull ASTNode node) {
    super(node);
  }
