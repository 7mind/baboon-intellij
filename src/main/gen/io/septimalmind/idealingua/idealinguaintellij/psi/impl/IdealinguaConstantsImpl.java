...
public class IdealinguaConstantsImpl extends ASTWrapperPsiElement implements IdealinguaConstants {

  public IdealinguaConstantsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<IdealinguaConstNoDoc> getConstNoDocList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, IdealinguaConstNoDoc.class);
  }
