...
public class BaboonIntersectionDefImpl extends ASTWrapperPsiElement implements BaboonIntersectionDef {

  public BaboonIntersectionDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BaboonVisitor visitor) {
    visitor.visitIntersectionDef(this);
  }
