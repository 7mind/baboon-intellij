...
public class BaboonStringLiteralImpl extends ASTWrapperPsiElement implements BaboonStringLiteral {

  public BaboonStringLiteralImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BaboonStringEscape> getStringEscapeList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BaboonStringEscape.class);
  }
