...
public class BaboonAdtImpl extends ASTWrapperPsiElement implements BaboonAdt {

  public BaboonAdtImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BaboonAdtMember> getAdtMemberList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BaboonAdtMember.class);
  }
