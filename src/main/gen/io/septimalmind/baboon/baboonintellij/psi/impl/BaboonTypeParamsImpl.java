...
public class BaboonTypeParamsImpl extends ASTWrapperPsiElement implements BaboonTypeParams {

  public BaboonTypeParamsImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BaboonTypeRef> getTypeRefList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BaboonTypeRef.class);
  }
