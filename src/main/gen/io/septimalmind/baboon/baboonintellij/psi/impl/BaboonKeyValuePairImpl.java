...
public class BaboonKeyValuePairImpl extends ASTWrapperPsiElement implements BaboonKeyValuePair {

  public BaboonKeyValuePairImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BaboonStringLiteral> getStringLiteralList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BaboonStringLiteral.class);
  }
