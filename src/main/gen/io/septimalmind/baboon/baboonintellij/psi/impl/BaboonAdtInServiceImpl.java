...
public class BaboonAdtInServiceImpl extends ASTWrapperPsiElement implements BaboonAdtInService {

  public BaboonAdtInServiceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BaboonVisitor visitor) {
    visitor.visitAdtInService(this);
  }
