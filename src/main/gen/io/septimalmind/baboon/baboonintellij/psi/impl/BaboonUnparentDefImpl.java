...
public class BaboonUnparentDefImpl extends ASTWrapperPsiElement implements BaboonUnparentDef {

  public BaboonUnparentDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BaboonVisitor visitor) {
    visitor.visitUnparentDef(this);
  }
