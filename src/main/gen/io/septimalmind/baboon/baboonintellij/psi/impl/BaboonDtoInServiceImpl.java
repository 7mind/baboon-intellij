...
public class BaboonDtoInServiceImpl extends ASTWrapperPsiElement implements BaboonDtoInService {

  public BaboonDtoInServiceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BaboonVisitor visitor) {
    visitor.visitDtoInService(this);
  }
