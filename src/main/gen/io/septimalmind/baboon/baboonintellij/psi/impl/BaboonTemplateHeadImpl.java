...
public class BaboonTemplateHeadImpl extends ASTWrapperPsiElement implements BaboonTemplateHead {

  public BaboonTemplateHeadImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BaboonVisitor visitor) {
    visitor.visitTemplateHead(this);
  }
