...
public class BaboonServiceMemberImpl extends ASTWrapperPsiElement implements BaboonServiceMember {

  public BaboonServiceMemberImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BaboonSignaturePart> getSignaturePartList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BaboonSignaturePart.class);
  }
