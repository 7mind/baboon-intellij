...
public class BaboonExtendedContractDefImpl extends ASTWrapperPsiElement implements BaboonExtendedContractDef {

  public BaboonExtendedContractDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BaboonVisitor visitor) {
    visitor.visitExtendedContractDef(this);
  }
