...
public class BaboonNamespaceImpl extends ASTWrapperPsiElement implements BaboonNamespace {

  public BaboonNamespaceImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<BaboonContent> getContentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, BaboonContent.class);
  }
