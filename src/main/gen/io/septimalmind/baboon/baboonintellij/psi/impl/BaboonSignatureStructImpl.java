...
public class BaboonSignatureStructImpl extends ASTWrapperPsiElement implements BaboonSignatureStruct {

  public BaboonSignatureStructImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BaboonVisitor visitor) {
    visitor.visitSignatureStruct(this);
  }
