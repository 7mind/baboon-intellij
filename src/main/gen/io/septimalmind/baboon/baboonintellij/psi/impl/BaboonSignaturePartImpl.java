...
public class BaboonSignaturePartImpl extends ASTWrapperPsiElement implements BaboonSignaturePart {

  public BaboonSignaturePartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BaboonVisitor visitor) {
    visitor.visitSignaturePart(this);
  }
