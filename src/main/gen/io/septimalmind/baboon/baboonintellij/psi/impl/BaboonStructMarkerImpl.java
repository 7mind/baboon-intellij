...
public class BaboonStructMarkerImpl extends ASTWrapperPsiElement implements BaboonStructMarker {

  public BaboonStructMarkerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BaboonVisitor visitor) {
    visitor.visitStructMarker(this);
  }
