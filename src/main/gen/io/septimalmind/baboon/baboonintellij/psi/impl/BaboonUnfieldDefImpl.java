...
public class BaboonUnfieldDefImpl extends ASTWrapperPsiElement implements BaboonUnfieldDef {

  public BaboonUnfieldDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull BaboonVisitor visitor) {
    visitor.visitUnfieldDef(this);
  }
